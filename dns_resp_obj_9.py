...
def handle_dns_request(packet):
    ...
    dns = DNS(id=packet[DNS].id, qd=packet[DNS].qd, aa=1, qr=1,  an=DNSRR(rrname=packet[DNS].qd.qname, ttl=100, rdata=ipaddr)) 
...
if __name__ == "__main__":
   ...
   #### DNS(id=pkt[DNS].id, qd=pkt[DNS].qd, aa=1, qr=1,  an=DNSRR(rrname=pkt[DNS].qd.qname, ttl=100, rdata=ipaddr)) 